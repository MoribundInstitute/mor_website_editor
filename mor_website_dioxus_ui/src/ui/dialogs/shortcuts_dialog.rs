...
const ACTIONS: &[(&str, &str, &str)] = &[
    ...
    ("exit_editor", "Exit Editor", "Global App"),
    ("open_project", "Open Website Folder", "Project & File"),
    ("save_project", "Save Theme to Site", "Project & File"),
    ("save_theme_config_as", "Save Theme Config As…", "Project & File"),
    ("undo", "Undo", "Workspace"),
    ("redo", "Redo", "Workspace"),
    ("copy_theme_css", "Copy Theme CSS", "Workspace"),
...
const FIXED: &[(&str, &str, &str)] = &[
    ...
    ("Alt+I", "Toggle Insert dock (blocks, images)", "Docks & Layout"),
    ("Alt+T", "Toggle Theme Palette (site-wide)", "Docks & Layout"),
    ("Alt+N", "Toggle Page dock (current PHP page)", "Docks & Layout"),
    ("Alt+X", "Toggle Inspector (clicked element)", "Docks & Layout"),
    ("Alt+R", "Toggle Presets", "Docks & Layout"),
    ("Alt+D", "Toggle Diagnostics", "Docks & Layout"),
    ("Alt+Shift+C", "Toggle CSS Editor", "Docks & Layout"),
    ("Alt+Shift+J", "Toggle JS Editor", "Docks & Layout"),
...
fn field_mut<'a>(sc: &'a mut ShortcutPrefs, id: &str) -> Option<&'a mut Option<String>> {
    Some(match id {
        ...
        "exit_editor" | "exit_architect" => &mut sc.exit_editor,
        "open_project" => &mut sc.open_project,
        "save_project" => &mut sc.save_project,
        "save_theme_config_as" | "export_xml" => &mut sc.save_theme_config_as,
        "undo" => &mut sc.undo,
        "redo" => &mut sc.redo,
        "copy_theme_css" | "copy_raw_xml" => &mut sc.copy_theme_css,
